...
const dummyDesign = require('../../../jersey-maker-mobile/assets/images/react-logo.png');
  ...
  const handleContinue = () => {
    router.push({
      ...
      params: {
        ...
        design: 'react-logo.png', // must match filename in /assets/images/
      },
    });
  };
  ...
  return (
    <ScrollView contentContainerStyle={{ padding: 20 }}>
      ...
      {avatars.map((avatar) => (
        <Pressable
          key={avatar.id}
          style={{ marginVertical: 10, borderWidth: selectedAvatar === avatar.id ? 2 : 0 }}
